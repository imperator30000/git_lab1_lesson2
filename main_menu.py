...
title_spin_time = Obj(pg.image.load('img/brick_.png'), (950, 500), (100, 100), 'Spin time', 'spin', '900', 40,
                      step_spin=10,
                      min_max=(100, 1000))
...
title_spin_radius = Obj(pg.image.load('img/brick_.png'), (950, 200), (100, 100), 'Spin hard', 'spin', '1',
                        min_max=(1, 20))
